...
export const ContainerResponsive = styled.div<IProps>`
 margin-top: 25px;
...
export const CardResponsive = styled.li<IProps>`
  width: 100px;
  height: 175px;
  background: #FFFFFF;
  border-radius: 5px;
...
export const ContainerFixe = styled.div`
  margin-top: 5px;
...
export const CardFixe = styled.li<IProps>`
  height: 175px;
  width: 90px;
